...
c	--------------
c	Make a file:
	open(6,file='energyAlO300K.txt')
	write(6,*)'temp:	  etot:	  ekin:	  epot:'
c	------------------------------------
c	The loops
	kk=0
	do while (kk.lt.320000)
c	  -------------
c	  displacement:
c	  -------------
	  temp=3500.0-kk*0.01
...
c	  parameters of Buckingham potential:1-Al, 3-O;
	  A(1)=1.483814
	  A(2)=3.442138
	  B(1)=0.064251
	  B(2)=0.260782
	  ...
	  C(2)=11.933349
	  D=0.0008433
c	  options: k=1-AlAl, k=2-AlO, k=3-OO
	  r=rij*rij
	  r=r*r*r
	  r=r*rij
	  Bij=B(cp1)+B(cp2)
...
c	  parameters of Buckingham potential:1-Al, 2-O;
	  A(1)=1.483814
	  A(2)=3.442138
	  B(1)=0.064251
	  B(2)=0.260782
